...
inline bool dynamic::isString() const { return get_nothrow<std::string>(); }
...
inline std::string& dynamic::getString() & { return get<std::string>(); }
...
inline StringPiece dynamic::stringPiece() const { return get<std::string>(); }
 ...
 public:
  ...
  void format(FormatArg& arg, FormatCallback& cb) const {
    ...
    case dynamic::ARRAY:
      ...
      break;
    case dynamic::OBJECT:
      FormatValue(val_.at(arg.splitKey().str())).format(arg, cb);
      break;
    }
  }
